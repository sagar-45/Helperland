  ...
  <section id="header">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
      <a class="navbar-brand" href="<?= $base_url.'?controller=Home&&function=index'?>">
        <img src="./assets/images/white-logo-transparent-background.png" class="img-fluid" alt="" />
      </a>
      ...
      <div class="mobile-view dashboard-item">
        ...
        <div class="offcanvas offcanvas-end" id="offcanvasR" aria-labelledby="offcanvasRightL">
          <ul>
            ...
            <li class="nav-item">
              <a class="nav-link name"><b>Sandip</b></a>
            </li>
            <hr />
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="sp_newService.html">New Service Requests</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="upcomingProject.html">Upcoming Services</a>
            </li>
            <li class="nav-item">
