      ...
      <div class="step_payment">
          ...
          <div class="tab-content">
            <div id="setup_service" class="tab-pane show active">
              ...
              <div class="input">
                ...
                <button class="btn continue" onclick="validate_postalcode(<?php echo $_SESSION['userId'] ?>)">Check Availability</button>
              </div>
            </div>
            <div id="schedule_plan" class="tab-pane fade">
              ...
              <div class="book_time">
                <div class="when">
                  ...
                  <div class="date">
                    ...
                    <input type="text" onchange="set_date()" value="<?php echo date("d/m/Y"); ?>" />
                  </div>
              ...
              <div class="hr12"></div>
              <button class="btn continue" onclick="from_schedule_plan_to_details(<?php echo $_SESSION['userId'] ?>)">Continue</button>
            </div>
        ...
        <div class="payment">
          <div class="card-pay">
            ...
            <div class="time"><span class="service_date"><?php echo date("d/m/Y"); ?></span> @ <span class="time_label">08:00</span><br><span class="bed_select">1</span> bed, <span class="bath_select">1</span> bath.</div>
            <div class="duration">
