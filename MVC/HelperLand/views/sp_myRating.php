...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./assets/css/sp_myRating.css" />
...
<body id="sp_new" onload="load_my_rating(<?php echo $_SESSION['userId']?>,'all')">
  ...
  <div class="mid-dash">
    <section id="list">
      <div class="list-group">
        ...
        <a class="list-group-item active" href="<?= $base_url . '?controller=Home&&function=sp_myRating' ?>">My Ratings</a>
    ...
    <section id="filter" class="table_page">
       <div class="only_mobile_view">My Rating</div>
        <div class="rating_status">
            Rating
            <select onchange="get_rating_filter(<?php echo $_SESSION['userId']?>)">
